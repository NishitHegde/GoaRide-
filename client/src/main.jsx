    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 text-white p-6 text-center space-y-4 font-sans">
          ...
          <h1 className="text-2xl font-black text-amber-400">GoaRide Notice</h1>
          <p className="text-sm text-slate-300 max-w-md leading-relaxed">
            An unexpected error occurred during loading. Click below to reload.
          </p>
          {this.state.error && (
            <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 text-rose-400 font-mono text-[11px] max-w-lg overflow-x-auto text-left">
